...
flowchart LR
  ...
  plugin_dsh_base_exploration_hygiene["exploration-hygiene<br/>@deepseek-ai/dsh-exploration-hygiene"]
  cfg --> plugin_dsh_base_exploration_hygiene
...
| `exploration-hygiene` | `@deepseek-ai/dsh-exploration-hygiene` |
