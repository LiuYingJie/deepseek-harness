...
| [`guard/`](guard/README.md) | Loop-hygiene guards: operating-contract prompt, advisory stall/repeat reminders, and the `tools/execute` deadline enforcer | Product — stable API |
