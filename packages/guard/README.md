...
Behavioral guard plugins watch the agent loop for unproductive patterns, contribute coding-agent operating-contract prompt text, and enforce per-call budgets. A guard is a self-contained consumer of core services and extension points, not a swappable capability.
...
| [`exploration-hygiene/`](exploration-hygiene/README.md) | Coding-agent operating contract plus inspection-stall reminders | prompt section plus tool and agent events |
