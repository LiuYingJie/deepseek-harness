...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  MemoryLedgerState: 'folded ledger state is owned by packages/memory/memory/src/index.ts',
  MemoryAddInput: 'service-local record input is owned by packages/memory/memory/src/index.ts',
  MemoryResolveInput: 'service-local resolve input is owned by packages/memory/memory/src/index.ts',
  MemoryRecord: 'ledger record contract is owned by packages/memory/memory/src/index.ts',
  ToolboxState: 'folded library state is owned by packages/extensions/toolbox/src/index.ts',
  ToolboxPublishInput: 'service-local publish input is owned by packages/extensions/toolbox/src/index.ts',
  ToolboxRecord: 'library version contract is owned by packages/extensions/toolbox/src/index.ts',
  RefineryState: 'folded stream state is owned by packages/extensions/refinery/src/index.ts',
  RefineryProposeInput: 'service-local propose input is owned by packages/extensions/refinery/src/index.ts',
  RefinerySettleInput: 'service-local settle input is owned by packages/extensions/refinery/src/index.ts',
  RefineryProposal: 'proposal contract is owned by packages/extensions/refinery/src/index.ts',
